  ...
  const projects = [
    {
      ...
      title: "solarAfriq",
      description:
        "SolarAfriq is a clean, responsive solar eCommerce site built with Next.js and Tailwind, connecting users with solar products and installers.",
      image: "/src/images/solar-afriq.jpeg",
    ...
    },
    {
      ...
      title: "Weather App",
      description:
        "A responsive weather application with real-time forecasts, location-based services, and interactive maps.",
      image:
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-800 transition-all duration-500 hover:transform hover:scale-[1.02]"
            >
