...
export function App() {
  ...
  if (isLoading) {
    return <div className="fixed inset-0 flex items-center justify-center bg-slate-900 text-white">
  ...
  return <div className="relative bg-slate-900 text-white min-h-screen overflow-hidden">
      <AnimatedBackground />
      <AnimatedCursor />
